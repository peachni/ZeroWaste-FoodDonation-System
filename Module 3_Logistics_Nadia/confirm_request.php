...
.btn-logout { background: white; color: #c0392b; padding: 8px 16px; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: 800; transition: 0.3s; border: 1px solid #c0392b; }
...
<div class="main-wrapper">
    <div class="welcome-card">
        <div>
            <h2>Confirm Distribution Request</h2>
            <div class="id-pill"><?= htmlspecialchars($display_id) ?> &nbsp;&nbsp;&nbsp; DONEE</div>
        </div>
    </div>
    ...
    <div class="form-card">
        <div class="item-summary">
            ...
            <div style="flex:1;">
                ...
                <p style="color:#7f8c8d; font-size:13px; margin: 5px 0;"><?= htmlspecialchars($item['Food_Desc']) ?></p>
        ...
        <form action="process_request.php" method="POST" onsubmit="return validateWastage()">
            ...
            <button type="submit" class="btn-submit">CONFIRM DISPATCH REQUEST</button>
        </form>
