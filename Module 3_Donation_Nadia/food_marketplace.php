...
.card { background: #fff; border-radius: 12px; border: 1px solid #eee; border-top: 5px solid var(--primary); box-shadow: 0 4px 10px rgba(0,0,0,0.02); display: flex; flex-direction: column; overflow: hidden; transition: 0.3s; cursor:pointer; }
...
.qty-tag { font-weight: 800; color: var(--primary); font-size: 13px; margin-top: auto; }

.btn-req { display: block; background: var(--primary); color: white; text-align: center; padding: 10px; border-radius: 8px; text-decoration: none; font-weight: 800; margin-top: 15px; font-size: 12px; transition: 0.3s; }
...
<header>
    ...
    <div class="header-right">
        <!-- Indicators and Logout removed per instructions -->
    </div>
</header>
...
<div class="main-wrapper">
    ...
    <div class="data-card">
        <span class="table-label">Verified Availability</span>
