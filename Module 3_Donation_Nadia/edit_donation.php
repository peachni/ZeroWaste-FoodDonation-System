...
$don = $res->fetch_assoc();
$is_delivery = ($don['has_delivery'] > 0 || ($don['delivery_address'] !== 'Self-Pickup' && !empty($don['delivery_address'])));
...
<head>
<meta charset="UTF-8">
<title>Update Donation | Zero Hunger</title>
...
<header>
    <div class="header-left">
        ...
        <div class="breadcrumb">
            ...
            <i class="fas fa-chevron-right"></i> 
            <span class="current">Edit Donation</span>
        </div>
    </div>
    <div class="header-right">
        <!-- Indicators and Logout button removed -->
    </div>
</header>
...
<div class="main-wrapper">
    <div class="welcome-card">
        <div>
            <h2>Donation Audit #<?= htmlspecialchars($id) ?></h2>
        </div>
    </div>
        ...
        <form method="POST">
            ...
            <?php if ($is_delivery): ?>
                ...
                <p style="font-size: 11px; color: #7f8c8d; margin-top: -15px; margin-bottom: 20px;">
                    * To assign/change a volunteer for this delivery, please use the <strong>Delivery</strong> module.
                </p>
            <?php endif; ?>

            <label>Delivery Status Update</label>
            <select name="status">
