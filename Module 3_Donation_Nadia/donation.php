...
<head>
<meta charset="UTF-8">
<title>Donation | Zero Hunger</title>
...
<body>
<header>
    <div class="header-left"><h1>Zero Hunger</h1><div class="breadcrumb"><a href="http://10.175.254.163:3000/<?= $role ?>Menu.php" class="past">Menu</a> <i class="fas fa-chevron-right"></i> <span class="current">Donation</span></div></div>
</header>
...
<div class="main-wrapper">
    <div class="welcome-card">
        ...
        <?php if ($role === 'admin'): ?>
            <a href="add_donation.php" class="btn-menu" style="background:var(--primary);"><i class="fas fa-calendar-plus"></i> New Donation</a>
        <?php endif; ?>
    </div>
    ...
    <div class="nav-section">
        <div class="nav-tabs">
            <a href="donation.php" class="active"><i class="fas fa-receipt"></i> Donation</a>
            <?php if ($role === 'admin'): ?>
...
<div id="detailModal" class="modal-overlay" onclick="this.style.display='none'">
    <div class="modal-box" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
            ...
            <div class="modal-row"><div class="modal-label">Item</div><div id="m-food"></div></div>
            ...
            <div class="modal-row" style="border:none;"><div class="modal-label">Volunteer</div><div id="m-vol"></div></div>
        </div>
    </div>
</div>
