...
$table_title = ($role === 'admin') ? "Global Delivery Audit" : "Fulfillment Tracking";
...
/* =========================
   3. SUMMARY STATS
========================= */
$stats = array_fill_keys(['All','Scheduled','Collected','Delivered','Cancelled'], 0);
...
$module_status = [
    ...
    'Donation' => check_module('10.175.254.3', 3307),   
...
<head>
<meta charset="UTF-8">
<title>Delivery | Zero Hunger</title>
...
<div class="main-wrapper">
    <div class="welcome-card">
        <div><h2>Welcome, <?= htmlspecialchars($user_name) ?></h2></div>
        <?php if ($role === 'admin'): ?>
            <a href="add_pickup.php" class="btn-menu" style="background:var(--primary);"><i class="fas fa-calendar-plus"></i> Schedule Pickup</a>
        <?php endif; ?>
    </div>
    ...
    <div class="nav-section">
        <div class="nav-tabs">
            ...
            <a href="pickup.php" class="active"><i class="fas fa-truck"></i> Delivery</a>
    ...
    <div class="data-card">
        ...
        <div class="table-controls">
            <div class="filter-links">
                <?php foreach(['All','Scheduled','Collected','Delivered','Cancelled'] as $f): ?>
            ...
            <table>
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="6" style="text-align:center; padding:50px; color:#95a5a6; font-weight:800; font-size: 15px;">No delivery
                             records found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<div id="logModal" class="modal-overlay" onclick="this.style.display='none'">
    <div class="modal-box" onclick="event.stopPropagation()">
        <div class="modal-header"><span>DELIVERY INFO</span><i class="fas fa-times" style="cursor:pointer" onclick="document.getElementById('logModal').style.display='none'"></i></div>
        <div class="modal-body">
            <div class="modal-row"><div class="modal-label">Pickup ID</div><div id="l-id"></div></div>
            <div class="modal-row"><div class="modal-label">Donation ID</div><div id="l-don"></div></div>
            <div class="modal-row"><div class="modal-label">Item</div><div id="l-food" style="font-weight:bold;"></div></div>
